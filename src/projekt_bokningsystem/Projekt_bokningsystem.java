...
public class Projekt_bokningsystem {
    /*OBS!
    p_fält står för personnummer fält, n_fält står för namn fält och k_fält står för kön fält. Detta gäller för alla metoder som tar emot antingen namn fältet, personnummers fältet eller kön fältet
    */
            ...
            if(fortsätt1) {
                ...
                while(true) {
                    ...
                    if(nummer_kön!=1 && nummer_kön!=2) {
                        System.out.print("Ditt svar måste vara 1 eller 2\nVal: ");
                    }
    ...
    static double räkna_vinst(int vuxna, int barn, int pensionärer) {
        ...
        return total + räkna_vinst(vuxna, barn, pensionärer);
    }
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("5. Beräkna vinsten av antalet sålda biljetter");
        System.out.println("6. Ta bort bokning: ange personnumret och bokning tas bort.");
        System.out.println("7. Skriv ut sorterad utskrift av alla boknignar");
        ...
        while(fortsätt) {
            switch(bokningslista()) {
                ...
                case 1: 
                    boka_plats(personnummer_bokning, namn_bokning, kön_bokning);             
                    break;
                case 2:
                    skriv_ut_lediga_platser(personnummer_bokning);
                    break;
                case 3:
                    hitta_bokning(personnummer_bokning, namn_bokning);
                    break;
                case 4:
                    över_under_18(personnummer_bokning);
                    break;
                case 5:
                    System.out.println("Vinst: "+ (int)räkna_vinst(antalVuxna(personnummer_bokning), antalBarn(personnummer_bokning), antalPensionärer(personnummer_bokning))+" Sek");
                    break;
                case 6:
                    ta_bort_bokning(personnummer_bokning, namn_bokning, kön_bokning);
                    break;
                case 7:
                    skriv_ut_sorterad_utskrift(personnummer_bokning, namn_bokning, kön_bokning);
                    break;
                case 8:
